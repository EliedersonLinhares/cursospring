...
import com.esl.cursospring.repositories.CidadeRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "eliederson250@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123") );
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "barbeiro@gmail.com", "99473055110", TipoCliente.PESSOAFISICA, pe.encode("456") );
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("27452456", "97894257"));
		

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "20106", null , "Centro", "28777012", cli2, c2);
